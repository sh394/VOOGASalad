...
public class AddToDefenderTabCommand extends FrontEndCommand {
    ...
    public void execute() {
        try {
            Method m = getEngineController().getClass().getDeclaredMethod(METHOD_NAME, String.class, String.class, Integer.TYPE);
            m.invoke(getEngineController(), filePath, defenderType, cost);
        } catch (Exception e) {
