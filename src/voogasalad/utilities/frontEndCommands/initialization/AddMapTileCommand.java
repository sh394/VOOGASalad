...
public class AddMapTileCommand extends FrontEndCommand {
    ...
    public void execute() {
        try {
            Method m = getEngineController().getClass().getDeclaredMethod(METHOD_NAME, String.class, Integer.TYPE, Integer.TYPE);
            m.invoke(getEngineController(), filePath, row, col);
        } catch (Exception e) {
